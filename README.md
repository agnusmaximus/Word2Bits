...
![Word Vector for "man"](images/visualize_nearest_man.png?raw=true | width=100) ![Word Vector for "science"](images/visualize_nearest_science.png?raw=true | width=100)
