...
\begin{figure}%
    \centering
    \subfloat[Training loss and accuracy vs epochs trained (vector dimension = 400) on 100MB of Wikipedia. Trends show that Word2Vec is prone to overfitting with many epochs of training.]{{\includegraphics[width=6cm]{images/Wiki8AccuracyVsEpochsTrainedDimension=400.pdf}}}%
    \qquad
    \subfloat[Training loss and accuracy vs dimension (epochs trained = 10) on 100MB of Wikipedia. Trends show that overfitting may occur with larger vector dimensions.]{{\includegraphics[width=6cm]{images/Wiki8AccuracyVsDimensionEpochsTrained=10.pdf} }}%
...
\begin{figure}%
    \centering
    \subfloat[]{{\includegraphics[width=6cm]{images/visualize_nearest_man.pdf}}}%
    \qquad
    \subfloat[]{{\includegraphics[width=6cm]{images/visualize_nearest_science.pdf}}}%
    \\
    \subfloat[]{{\includegraphics[width=6cm]{images/visualize_nearest_mushroom.pdf}}}%
    \qquad
    \subfloat[]{{\includegraphics[width=6cm]{images/visualize_nearest_language.pdf}}}%
    \\
    \subfloat[]{{\includegraphics[width=6cm]{images/visualize_nearest_sport.pdf}}}%
    \qquad
    \subfloat[]{{\includegraphics[width=6cm]{images/visualize_nearest_excited.pdf}}}%
